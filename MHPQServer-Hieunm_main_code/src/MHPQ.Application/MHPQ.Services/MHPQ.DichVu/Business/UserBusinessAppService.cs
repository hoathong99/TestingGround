...
{
    public interface IUserBusinessAppService : IApplicationService
    {
    ...
    public  class UserBusinessAppService : MHPQAppServiceBase, IUserBusinessAppService
    {
