...
namespace MHPQ.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(MHPQDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissionAdminCitizen = _context.RolePermissions.FirstOrDefault(p => (p.Name == PermissionNames.Pages_SmartCommunity_Citizen) && (p.RoleId == roleCitizen.Id));
