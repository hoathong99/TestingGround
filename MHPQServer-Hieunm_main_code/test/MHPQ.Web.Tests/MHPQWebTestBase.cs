...
{
    public abstract class MHPQWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MHPQWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MHPQWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MHPQDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MHPQDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MHPQDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MHPQDbContext, Task<T>> func)
        {
            T result;
